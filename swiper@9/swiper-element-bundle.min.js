...
! function() {
    ...
    var O = {
        ...
        updateSlides: function() {
            ...
            let A = i.spaceBetween,
                ...
                C = 0;
            if (void 0 === n) return;
            "string" == typeof A && A.indexOf("%") >= 0 ? A = parseFloat(A.replace("%", "")) / 100 * n : "string" == typeof A && (A = parseFloat(A)), e.virtualSize = -A, c.forEach((e => {
            ...
            for (let a = 0; a < m; a += 1) {
                ...
                if (z = 0, c[a] && (r = c[a]), P && e.grid.updateSlide(a, r, m, t), !c[a] || "none" !== w(r, "display")) {
                    ...
                    c[a] && (c[a].swiperSlideSize = z), v.push(z), i.centeredSlides ? (T = T + z / 2 + M / 2 + A, 0 === M && 0 !== a && (T = T - n / 2 - A), 0 === a && (T = T - n / 2 - A), Math.abs(T) < .001 && (T = 0), i.roundLengths && (T = Math.floor(T)), C % i.slidesPerGroup == 0 && h.push(T), g.push(T)) : (i.roundLengths && (T = Math.floor(T)), (C - Math.min(e.params.slidesPerGroupSkip, C)) % e.params.slidesPerGroup == 0 && h.push(T), g.push(T), T = T + z + A), e.virtualSize += z + A, M = z, C += 1
                }
            }
            if (e.virtualSize = Math.max(e.virtualSize, n) + y, l && o && ("slide" === i.effect || "coverflow" === i.effect) && (a.style.width = `${e.virtualSize+A}px`), i.setWrapperSize && (a.style[t("width")] = `${e.virtualSize+A}px`), P && e.grid.updateWrapperSize(z, h, t), !i.centeredSlides) {
                const t = [];
            ...
            if (m !== p && e.emit("slidesLengthChange"), h.length !== x && (e.params.watchOverflow && e.checkOverflow(), e.emit("snapGridLengthChange")), g.length !== S && e.emit("slidesGridLengthChange"), i.watchSlidesProgress && e.updateSlidesOffset(), !(d || i.cssMode || "slide" !== i.effect && "fade" !== i.effect)) {
    ...
    var B = {
        ...
        slideToClickedSlide: function() {
            ...
            if (t.loop) {
                ...
                a = parseInt(e.clickedSlide.getAttribute("data-swiper-slide-index"), 10), t.centeredSlides ? r < e.loopedSlides - i / 2 || r > e.slides.length - e.loopedSlides + i / 2 ? (e.loopFix(), r = e.getSlideIndex(f(s, `${l}[data-swiper-slide-index="${a}"]`)[0]), n((() => {
                    e.slideTo(r)
                }))) : e.slideTo(r) : r > e.slides.length - i ? (e.loopFix(), r = e.getSlideIndex(f(s, `${l}[data-swiper-slide-index="${a}"]`)[0]), n((() => {
                    e.slideTo(r)
                }))) : e.slideTo(r)
            } else e.slideTo(r)
        }
    ...
    const V = (e, t) => {
        ...
        r[d]("pointerdown", e.onTouchStart, {
            ...
            passive: !0
        }), (a.preventClicks || a.preventClicksPropagation) && r[d]("click", e.onClick, !0), a.cssMode && n[d]("scroll", e.onScroll), a.updateOnWindowResize ? e[p](l.ios || l.android ? "resize orientationchange observerUpdate" : "resize observerUpdate", _, !0) : e[p]("observerUpdate", _, !0), r[d]("load", e.onLoad, {
            capture: !0
        })
    };
    ...
    const Z = {
            ...
            events: {
                attachEvents: function() {
                    ...
                    e.onTouchStart = Y.bind(e), e.onTouchMove = H.bind(e), e.onTouchEnd = N.bind(e), s.cssMode && (e.onScroll = R.bind(e)), e.onClick = X.bind(e), e.onLoad = F.bind(e), j || (t.addEventListener("touchstart", q), j = !0), V(e, "on")
                },
    ...
    class J {
        ...
        mount(e) {
            ...
            return !a && t.params.createElements && (a = g("div", t.params.wrapperClass), s.append(a), f(s, `.${t.params.slideClass}`).forEach((e => {
                a.append(e)
            }))), Object.assign(t, {
                el: s,
                wrapperEl: a,
    ...
    const ce = [function(e) {
        ...
        function d(e, t) {
            ...
            let a;
            return i.renderSlide ? (a = i.renderSlide.call(s, e, t), "string" == typeof a && (o.innerHTML = a, a = o.children[0])) : a = s.isElement ? g("swiper-slide") : g("div", s.params.slideClass), a.setAttribute("data-swiper-slide-index", t), i.renderSlide || (a.innerHTML = e), i.cache && (s.virtual.cache[t] = a), a
        }
        ...
        function u() {
            ...
            if (t.params.loop ? (r = t.previousRealIndex || 0, i = t.params.slidesPerGroup > 1 ? Math.floor(t.realIndex / t.params.slidesPerGroup) : t.realIndex) : void 0 !== t.snapIndex ? (i = t.snapIndex, r = t.previousSnapIndex) : (r = t.previousIndex || 0, i = t.activeIndex || 0), "bullets" === s.type && t.pagination.bullets && t.pagination.bullets.length > 0) {
                ...
                let o, d, u;
                if (s.dynamicBullets && (n = E(a[0], t.isHorizontal() ? "width" : "height", !0), c.forEach((e => {
        ...
        const a = (e, s) => {
            ...
            r = () => {
                ...
                f(e, "[data-swiper-parallax], [data-swiper-parallax-x], [data-swiper-parallax-y], [data-swiper-parallax-opacity], [data-swiper-parallax-scale]").forEach((e => {
                    ...
                    let n = e.progress;
                    t.params.slidesPerGroup > 1 && "auto" !== t.params.slidesPerView && (n += Math.ceil(s / 2) - i * (r.length - 1)), n = Math.min(Math.max(n, -1), 1), e.querySelectorAll("[data-swiper-parallax], [data-swiper-parallax-x], [data-swiper-parallax-y], [data-swiper-parallax-opacity], [data-swiper-parallax-scale], [data-swiper-parallax-rotate]").forEach((e => {
                        a(e, n)
                    }))
                }))
            };
        ...
        function E(e) {
            ...
            if (l = !1, d = !1, u.push(e), !(u.length < 2)) {
                if (l = !0, m.scaleStart = b(), !m.slideEl) {
                    ...
                    if (i && (i = i.querySelectorAll("picture, img, svg, canvas, .swiper-zoom-target")[0]), m.imageEl = i, m.imageWrapEl = i ? y(m.imageEl, `.${s.containerClass}`)[0] : void 0, !m.imageWrapEl) return void(m.imageEl = void 0);
        ...
        function S(e) {
            ...
            a >= 0 && (u[a] = e), u.length < 2 || (d = !0, m.scaleMove = b(), m.imageEl && (i.scale = m.scaleMove / m.scaleStart * p, i.scale > m.maxRatio && (i.scale = m.maxRatio - 1 + (i.scale - m.maxRatio + 1) ** .5), i.scale < s.minRatio && (i.scale = s.minRatio + 1 - (s.minRatio - i.scale + 1) ** .5), m.imageEl.style.transform = `translate3d(0,0,0) scale(${i.scale})`))
        }
        ...
        i("beforeInit", (() => {
            ...
            t.params.a11y.enabled && function() {
                ...
                f() && t.pagination.bullets.forEach((s => {
                    t.params.pagination.clickable && (l(s), t.params.pagination.renderBullet || (d(s, "button"), c(s, e.paginationBulletMessage.replace(/\{\{index\}\}/, b(s) + 1)))), s.matches(te(t.params.pagination.bulletActiveClass)) ? s.setAttribute("aria-current", "true") : s.removeAttribute("aria-current")
                }))
            }()
        })), i("destroy", (() => {
            t.params.a11y.enabled && function() {
        ...
        n("init", (() => {
            a.params.autoplay.enabled && (a.params.autoplay.pauseOnMouseEnter && (a.el.addEventListener("pointerenter", C), a.el.addEventListener("pointerleave", P)), i().addEventListener("visibilitychange", M), w = (new Date).getTime(), E())
        })), n("destroy", (() => {
                ...
                onTouchEnd: function(e) {
                    ...
                    if (s < -t.minTranslate()) t.slideTo(t.activeIndex);
                        ...
                        if (r.freeMode.momentum) {
                            ...
                            r.freeMode.momentumBounce && m ? (t.updateProgress(u), t.setTransition(e), t.setTranslate(c), t.transitionStart(!0, t.swipeDirection), t.animating = !0, x(n, (() => {
                                t && !t.destroyed && p.allowMomentumBounce && (i("momentumBounce"), t.setTransition(r.speed), setTimeout((() => {
                                    t.setTranslate(u), x(n, (() => {
                                        t && !t.destroyed && t.transitionEnd()
                                    }))
                                }), 0))
                            }))) : t.velocity ? (i("_freeModeNoMomentumRelease"), t.updateProgress(c), t.setTransition(e), t.setTranslate(c), t.transitionStart(!0, t.swipeDirection), t.animating || (t.animating = !0, x(n, (() => {
                                t && !t.destroyed && t.transitionEnd()
        ...
        const a = (e, t, s) => {
            ...
            i || (i = g("div", "swiper-slide-shadow-" + (s ? "left" : "top")), e.append(i)), a || (a = g("div", "swiper-slide-shadow-" + (s ? "right" : "bottom")), e.append(a)), i && (i.style.opacity = Math.max(-t, 0)), a && (a.style.opacity = Math.max(t, 0))
        };
        le({
            effect: "cube",
            swiper: t,
            ...
            setTranslate: () => {
                ...
                let m, h = 0;
                p.shadow && (c ? (m = t.slidesEl.querySelector(".swiper-cube-shadow"), m || (m = g("div", "swiper-cube-shadow"), t.slidesEl.append(m)), m.style.height = `${r}px`) : (m = e.querySelector(".swiper-cube-shadow"), m || (m = g("div", "swiper-cube-shadow"), e.append(m))));
                for (let e = 0; e < i.length; e += 1) {
                    const t = i[e];
                    let s = e;
            ...
            setTranslate: () => {
                ...
                for (let o = 0; o < e.length; o += 1) {
                    ...
                    if (a.slideShadows) {
                        ...
                        e || (e = pe(0, d)), e && (e.style.opacity = Math.min(Math.max((Math.abs(c) - .5) / .5, 0), 1))
                    }
    ...
    const ge = e => parseFloat(e) === Number(e) ? Number(e) : "true" === e || ("" === e || "false" !== e && ("null" === e ? null : "undefined" !== e ? e : void 0)),
        ve = ["a11y", "autoplay", "controller", "cards-effect", "coverflow-effect", "creative-effect", "cube-effect", "fade-effect", "flip-effect", "free-mode", "grid", "hash-navigation", "history", "keyboard", "mousewheel", "navigation", "pagination", "parallax", "scrollbar", "thumbs", "virtual", "zoom"];
    ...
    function we(e, t, s) {
        ...
        return "string" == typeof t && void 0 !== s && l.push({
            ...
            if (t) {
                ...
                const s = ge(e.value);
                a[t] && ve.includes(e.name) ? (a[t].constructor !== Object && (a[t] = {}), a[t].enabled = s) : a[t] = s
            }
        })), he(i, a), i.navigation ? i.navigation = {
            prevEl: ".swiper-button-prev",
            nextEl: ".swiper-button-next",
    ...
    class Se extends Ee {
        ...
        render() {
            ...
            var t;
            e.length && (this.stylesEl = document.createElement("style"), this.stylesEl.textContent = e, this.shadowEl.appendChild(this.stylesEl)), this.cssLinks().forEach((e => {
        ...
        initialize() {
            ...
            this.swiperParams = t, this.passedParams = s, delete this.swiperParams.init, this.render(), this.swiper = new J(this, { ...t,
        ...
        connectedCallback() {
            this.initialized && this.nested && this.closest("swiper-slide") && this.closest("swiper-slide").swiperLoopMoveDOM || (!1 !== this.init && "false" !== this.getAttribute("init") ? this.initialize() : xe(!0, this))
        }
            ...
            this.passedParams = i, this.swiperParams = s,
                function(e) {
                    ...
                    a.includes("loop") && t.isElement && (p.loop && !i.loop ? x = !0 : !p.loop && i.loop ? E = !0 : S = !0), d.forEach((e => {
                        if (me(p[e]) && me(i[e])) he(p[e], i[e]), "navigation" !== e && "pagination" !== e && "scrollbar" !== e || !("enabled" in i[e]) || i[e].enabled || A(e);
                        else {
                            const t = i[e];
                            !0 !== t && !1 !== t || "navigation" !== e && "pagination" !== e && "scrollbar" !== e ? p[e] = i[e] : !1 === t && A(e)
                        }
        ...
        static get observedAttributes() {
            return ue.filter((e => e.includes("_"))).map((e => e.replace(/[A-Z]/g, (e => `-${e}`)).replace("_", "").toLowerCase()))
        }
    }
    ue.forEach((e => {
        "init" !== e && (e = e.replace("_", ""), Object.defineProperty(Se.prototype, e, {
            configurable: !0,
            get() {
    ...
    class Ae extends Ee {
        ...
        render() {
            ...
            if (this.tempDiv.innerHTML = "<slot />", [...this.tempDiv.children].forEach((e => {
                    this.shadowEl.appendChild(e)
                })), e) {
    ...
    "undefined" != typeof window && (window.SwiperElementRegisterParams = e => {
        ue.push(...e)
    }), void 0 === Te && (Te = !0), "undefined" != typeof window && (Te || (ye = !1), ye && xe(!0), window.customElements.get("swiper-container") || window.customElements.define("swiper-container", Se), window.customElements.get("swiper-slide") || window.customElements.define("swiper-slide", Ae))
}();
